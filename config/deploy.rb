...
set :repository,  "git://github.com/dmitryame/preallowed.git" 
set :scm, "git"
...
role :app, "preallowed.com"
role :web, "preallowed.com"
role :db,  "preallowed.com", :primary => true
